...
struct UnityARHitTestExample1_t121388200;
...
extern const uint32_t UnityARHitTestExample1_HitTestWithResultType_m3369834981_MetadataUsageId;
...
// System.Void UnityEngine.XR.iOS.UnityARHitTestExample1::StopPlayMusicFunc(UnityEngine.AudioSource,UnityEngine.Transform)
extern "C"  void UnityARHitTestExample1_StopPlayMusicFunc_m3114090679 (UnityARHitTestExample1_t121388200 * __this, AudioSource_t1135106623 * ___audio0, Transform_t3275118058 * ___objectA1, const MethodInfo* method) IL2CPP_METHOD_ATTR;
// System.Void UnityEngine.XR.iOS.UnityARHitTestExample1::PlayMusicFunc(UnityEngine.AudioSource,UnityEngine.Transform)
extern "C"  void UnityARHitTestExample1_PlayMusicFunc_m2181365943 (UnityARHitTestExample1_t121388200 * __this, AudioSource_t1135106623 * ___audio0, Transform_t3275118058 * ___objectA1, const MethodInfo* method) IL2CPP_METHOD_ATTR;
...
// System.Boolean UnityEngine.XR.iOS.UnityARHitTestExample1::HitTestWithResultType(UnityEngine.XR.iOS.ARPoint,UnityEngine.XR.iOS.ARHitTestResultType)
extern "C"  bool UnityARHitTestExample1_HitTestWithResultType_m3369834981 (UnityARHitTestExample1_t121388200 * __this, ARPoint_t3436811567  ___point0, int64_t ___resultTypes1, const MethodInfo* method) IL2CPP_METHOD_ATTR;
...
IL_0025:
		{
			...
			GameObject_t1756533147 * L_9 = __this->get_newBoxFloor_3();
			...
			Matrix4x4_t2933234003  L_12 = (&V_1)->get_worldTransform_3();
			Quaternion_t4030073918  L_13 = UnityARMatrixOps_GetRotation_m1002641986(NULL /*static, unused*/, L_12, /*hidden argument*/NULL);
			IL2CPP_RUNTIME_CLASS_INIT(Object_t1021602117_il2cpp_TypeInfo_var);
			Object_Instantiate_TisGameObject_t1756533147_m3186302158(NULL /*static, unused*/, L_9, L_11, L_13, /*hidden argument*/Object_Instantiate_TisGameObject_t1756533147_m3186302158_MethodInfo_var);
			Transform_t3275118058 * L_14 = __this->get_m_HitTransform_2();
			Matrix4x4_t2933234003  L_15 = (&V_1)->get_worldTransform_3();
			Vector3_t2243707580  L_16 = UnityARMatrixOps_GetPosition_m1153858439(NULL /*static, unused*/, L_15, /*hidden argument*/NULL);
			NullCheck(L_14);
			Transform_set_position_m2469242620(L_14, L_16, /*hidden argument*/NULL);
			Transform_t3275118058 * L_17 = __this->get_m_HitTransform_2();
			Matrix4x4_t2933234003  L_18 = (&V_1)->get_worldTransform_3();
			Quaternion_t4030073918  L_19 = UnityARMatrixOps_GetRotation_m1002641986(NULL /*static, unused*/, L_18, /*hidden argument*/NULL);
			NullCheck(L_17);
			...
			Transform_t3275118058 * L_30 = __this->get_m_HitTransform_2();
			NullCheck(L_30);
			...
			String_t* L_35 = String_Format_m4262916296(NULL /*static, unused*/, _stringLiteral1537444060, L_24, L_29, L_34, /*hidden argument*/NULL);
			Debug_Log_m920475918(NULL /*static, unused*/, L_35, /*hidden argument*/NULL);
			V_6 = (bool)1;
			IL2CPP_LEAVE(0x10B, FINALLY_00fb);
		}

IL_00ea:
		{
			bool L_36 = Enumerator_MoveNext_m3661301011((&V_2), /*hidden argument*/Enumerator_MoveNext_m3661301011_MethodInfo_var);
			if (L_36)
			{
				goto IL_0025;
			}
...
extern "C"  void UnityARHitTestExample_Update_m1266118659 (UnityARHitTestExample_t146867607 * __this, const MethodInfo* method)
{
	...
	}
	{
		...
		NullCheck(L_7);
		Vector3_t2243707580  L_10 = Camera_ScreenToViewportPoint_m2666228286(L_7, L_9, /*hidden argument*/NULL);
		V_1 = L_10;
		Initobj (ARPoint_t3436811567_il2cpp_TypeInfo_var, (&V_3));
		float L_11 = (&V_1)->get_x_1();
		(&V_3)->set_x_0((((double)((double)L_11))));
		float L_12 = (&V_1)->get_y_2();
		(&V_3)->set_y_1((((double)((double)L_12))));
		ARPoint_t3436811567  L_13 = V_3;
		V_2 = L_13;
		ARHitTestResultTypeU5BU5D_t1303085420* L_14 = ((ARHitTestResultTypeU5BU5D_t1303085420*)SZArrayNew(ARHitTestResultTypeU5BU5D_t1303085420_il2cpp_TypeInfo_var, (uint32_t)3));
		RuntimeHelpers_InitializeArray_m3920580167(NULL /*static, unused*/, (Il2CppArray *)(Il2CppArray *)L_14, LoadFieldToken(U3CPrivateImplementationDetailsU3E_t1486305142____U24fieldU2D8E7629AD5AF686202B8CB7C014505C432FFE31E6_0_FieldInfo_var), /*hidden argument*/NULL);
		V_4 = L_14;
		ARHitTestResultTypeU5BU5D_t1303085420* L_15 = V_4;
		V_6 = L_15;
		V_7 = 0;
		goto IL_00b9;
	}
...
IL_009d:
	{
		ARHitTestResultTypeU5BU5D_t1303085420* L_16 = V_6;
		int32_t L_17 = V_7;
		NullCheck(L_16);
		int32_t L_18 = L_17;
		int64_t L_19 = (L_16)->GetAt(static_cast<il2cpp_array_size_t>(L_18));
		V_5 = L_19;
		ARPoint_t3436811567  L_20 = V_2;
		int64_t L_21 = V_5;
		bool L_22 = UnityARHitTestExample_HitTestWithResultType_m996939112(__this, L_20, L_21, /*hidden argument*/NULL);
		if (!L_22)
		{
			goto IL_00b3;
		}
...
IL_00b9:
	{
		int32_t L_24 = V_7;
		ARHitTestResultTypeU5BU5D_t1303085420* L_25 = V_6;
		NullCheck(L_25);
...
// System.Void UnityEngine.XR.iOS.UnityARHitTestExample1::.ctor()
extern "C"  void UnityARHitTestExample1__ctor_m2073185127 (UnityARHitTestExample1_t121388200 * __this, const MethodInfo* method)
{
	{
...
// System.Boolean UnityEngine.XR.iOS.UnityARHitTestExample1::HitTestWithResultType(UnityEngine.XR.iOS.ARPoint,UnityEngine.XR.iOS.ARHitTestResultType)
extern "C"  bool UnityARHitTestExample1_HitTestWithResultType_m3369834981 (UnityARHitTestExample1_t121388200 * __this, ARPoint_t3436811567  ___point0, int64_t ___resultTypes1, const MethodInfo* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (UnityARHitTestExample1_HitTestWithResultType_m3369834981_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	List_1_t2644634157 * V_0 = NULL;
	ARHitTestResult_t3275513025  V_1;
...
// System.Void UnityEngine.XR.iOS.UnityARHitTestExample1::Update()
extern "C"  void UnityARHitTestExample1_Update_m3503350450 (UnityARHitTestExample1_t121388200 * __this, const MethodInfo* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (UnityARHitTestExample1_Update_m3503350450_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	...
	}
	{
		...
		NullCheck(L_14);
		bool L_15 = Component_CompareTag_m3443292365(L_14, _stringLiteral489976614, /*hidden argument*/NULL);
		if (!L_15)
		{
			goto IL_00fe;
		}
	}
	{
		...
		bool L_16 = __this->get_firstTime_3();
		if (L_16)
		{
			goto IL_00cd;
		}
	...
	{
		RaycastHit_t87180320 * L_17 = __this->get_address_of_raycastHitPrev_4();
		Collider_t3497673348 * L_18 = RaycastHit_get_collider_m301198172(L_17, /*hidden argument*/NULL);
		NullCheck(L_18);
		GameObject_t1756533147 * L_19 = Component_get_gameObject_m3105766835(L_18, /*hidden argument*/NULL);
		NullCheck(L_19);
		AudioSource_t1135106623 * L_20 = GameObject_GetComponent_TisAudioSource_t1135106623_m1072053017(L_19, /*hidden argument*/GameObject_GetComponent_TisAudioSource_t1135106623_m1072053017_MethodInfo_var);
		RaycastHit_t87180320 * L_21 = __this->get_address_of_raycastHitPrev_4();
		Collider_t3497673348 * L_22 = RaycastHit_get_collider_m301198172(L_21, /*hidden argument*/NULL);
		NullCheck(L_22);
		Transform_t3275118058 * L_23 = Component_get_transform_m2697483695(L_22, /*hidden argument*/NULL);
		UnityARHitTestExample1_StopPlayMusicFunc_m3114090679(__this, L_20, L_23, /*hidden argument*/NULL);
	}

IL_00cd:
	{
		__this->set_firstTime_3((bool)0);
		RaycastHit_t87180320  L_24 = V_0;
		__this->set_raycastHitPrev_4(L_24);
		Collider_t3497673348 * L_25 = RaycastHit_get_collider_m301198172((&V_0), /*hidden argument*/NULL);
		NullCheck(L_25);
		GameObject_t1756533147 * L_26 = Component_get_gameObject_m3105766835(L_25, /*hidden argument*/NULL);
		NullCheck(L_26);
		AudioSource_t1135106623 * L_27 = GameObject_GetComponent_TisAudioSource_t1135106623_m1072053017(L_26, /*hidden argument*/GameObject_GetComponent_TisAudioSource_t1135106623_m1072053017_MethodInfo_var);
		Collider_t3497673348 * L_28 = RaycastHit_get_collider_m301198172((&V_0), /*hidden argument*/NULL);
		NullCheck(L_28);
		Transform_t3275118058 * L_29 = Component_get_transform_m2697483695(L_28, /*hidden argument*/NULL);
		UnityARHitTestExample1_PlayMusicFunc_m2181365943(__this, L_27, L_29, /*hidden argument*/NULL);
	}

IL_00fe:
	{
		int32_t L_30 = Touch_get_phase_m196706494((&V_1), /*hidden argument*/NULL);
		if (L_30)
		{
			goto IL_01a3;
		}
	}
	{
		...
		Vector2_t2243707579  L_34 = Touch_get_position_m2079703643((&V_1), /*hidden argument*/NULL);
		...
		(&V_7)->set_x_0((((double)((double)L_37))));
		float L_38 = (&V_5)->get_y_2();
		(&V_7)->set_y_1((((double)((double)L_38))));
		ARPoint_t3436811567  L_39 = V_7;
		V_6 = L_39;
		ARHitTestResultTypeU5BU5D_t1303085420* L_40 = ((ARHitTestResultTypeU5BU5D_t1303085420*)SZArrayNew(ARHitTestResultTypeU5BU5D_t1303085420_il2cpp_TypeInfo_var, (uint32_t)3));
		RuntimeHelpers_InitializeArray_m3920580167(NULL /*static, unused*/, (Il2CppArray *)(Il2CppArray *)L_40, LoadFieldToken(U3CPrivateImplementationDetailsU3E_t1486305142____U24fieldU2D8E7629AD5AF686202B8CB7C014505C432FFE31E6_0_FieldInfo_var), /*hidden argument*/NULL);
		V_8 = L_40;
		ARHitTestResultTypeU5BU5D_t1303085420* L_41 = V_8;
		V_10 = L_41;
		V_11 = 0;
		goto IL_0198;
	}
...
IL_017b:
	{
		ARHitTestResultTypeU5BU5D_t1303085420* L_42 = V_10;
		int32_t L_43 = V_11;
		NullCheck(L_42);
		int32_t L_44 = L_43;
		int64_t L_45 = (L_42)->GetAt(static_cast<il2cpp_array_size_t>(L_44));
		V_9 = L_45;
		ARPoint_t3436811567  L_46 = V_6;
		int64_t L_47 = V_9;
		bool L_48 = UnityARHitTestExample1_HitTestWithResultType_m3369834981(__this, L_46, L_47, /*hidden argument*/NULL);
		if (!L_48)
		{
			goto IL_0192;
		}
...
IL_0198:
	{
		int32_t L_50 = V_11;
		ARHitTestResultTypeU5BU5D_t1303085420* L_51 = V_10;
		NullCheck(L_51);
...
// System.Void UnityEngine.XR.iOS.UnityARHitTestExample1::PlayMusicFunc(UnityEngine.AudioSource,UnityEngine.Transform)
extern "C"  void UnityARHitTestExample1_PlayMusicFunc_m2181365943 (UnityARHitTestExample1_t121388200 * __this, AudioSource_t1135106623 * ___audio0, Transform_t3275118058 * ___objectA1, const MethodInfo* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (UnityARHitTestExample1_PlayMusicFunc_m2181365943_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	{
		IL2CPP_RUNTIME_CLASS_INIT(Debug_t1368543263_il2cpp_TypeInfo_var);
		Debug_Log_m920475918(NULL /*static, unused*/, _stringLiteral1809839953, /*hidden argument*/NULL);
		Transform_t3275118058 * L_0 = ___objectA1;
...
// System.Void UnityEngine.XR.iOS.UnityARHitTestExample1::StopPlayMusicFunc(UnityEngine.AudioSource,UnityEngine.Transform)
extern "C"  void UnityARHitTestExample1_StopPlayMusicFunc_m3114090679 (UnityARHitTestExample1_t121388200 * __this, AudioSource_t1135106623 * ___audio0, Transform_t3275118058 * ___objectA1, const MethodInfo* method)
{
	{
		Transform_t3275118058 * L_0 = ___objectA1;
		Transform_t3275118058 * L_1 = L_0;
...
extern "C"  void UnityARHitTestExample2_Update_m3461779921 (UnityARHitTestExample2_t121388197 * __this, const MethodInfo* method)
{
	...
	ARPoint_t3436811567  V_3;
	memset(&V_3, 0, sizeof(V_3));
	ARPoint_t3436811567  V_4;
	memset(&V_4, 0, sizeof(V_4));
	ARHitTestResultTypeU5BU5D_t1303085420* V_5 = NULL;
	int64_t V_6 = 0;
	ARHitTestResultTypeU5BU5D_t1303085420* V_7 = NULL;
	int32_t V_8 = 0;
	{
		IL2CPP_RUNTIME_CLASS_INIT(Input_t1785128008_il2cpp_TypeInfo_var);
		int32_t L_0 = Input_get_touchCount_m2050827666(NULL /*static, unused*/, /*hidden argument*/NULL);
	...
	}
	{
		...
		Touch_t407273883  L_3 = Input_GetTouch_m1463942798(NULL /*static, unused*/, 0, /*hidden argument*/NULL);
		V_1 = L_3;
		int32_t L_4 = Touch_get_phase_m196706494((&V_1), /*hidden argument*/NULL);
		if (L_4)
		{
			goto IL_00b5;
		}
	}
	{
		...
		V_2 = L_8;
		Initobj (ARPoint_t3436811567_il2cpp_TypeInfo_var, (&V_4));
		float L_9 = (&V_2)->get_x_1();
		(&V_4)->set_x_0((((double)((double)L_9))));
		float L_10 = (&V_2)->get_y_2();
		(&V_4)->set_y_1((((double)((double)L_10))));
		ARPoint_t3436811567  L_11 = V_4;
		V_3 = L_11;
		...
		V_5 = L_12;
		ARHitTestResultTypeU5BU5D_t1303085420* L_13 = V_5;
		V_7 = L_13;
		V_8 = 0;
		goto IL_00aa;
	}
...
IL_008e:
	{
		ARHitTestResultTypeU5BU5D_t1303085420* L_14 = V_7;
		int32_t L_15 = V_8;
		NullCheck(L_14);
		int32_t L_16 = L_15;
		int64_t L_17 = (L_14)->GetAt(static_cast<il2cpp_array_size_t>(L_16));
		V_6 = L_17;
		ARPoint_t3436811567  L_18 = V_3;
		int64_t L_19 = V_6;
		bool L_20 = UnityARHitTestExample2_HitTestWithResultType_m2984706784(__this, L_18, L_19, /*hidden argument*/NULL);
		if (!L_20)
		{
			goto IL_00a4;
		}
...
IL_00aa:
	{
		int32_t L_22 = V_8;
		ARHitTestResultTypeU5BU5D_t1303085420* L_23 = V_7;
		NullCheck(L_23);
		if ((((int32_t)L_22) < ((int32_t)(((int32_t)((int32_t)(((Il2CppArray *)L_23)->max_length)))))))
		{
			goto IL_008e;
